...
class modMyModule extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->numero = 500042;		// TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
		...
		$this->descriptionlong = "Ceci est une description plus longue.";

		$this->editor_name = 'bchevali';
